...
<div class="container">
    <?php 
            ...
            $id = htmlspecialchars($_GET["C"]); 
    ?>
    <body>
        <section>
            <h2 class="main-content-title">Editar</h2>
            <form id="form" action="includes/update.php" method="POST">
                <div class="row">
                        ...
                        <div class="row">
                            <p class="buttons-center mt-5">
                                <input type="submit" class="button-default btn btn-outline-success" name="btn-atualizar" value="Atualizar">   
